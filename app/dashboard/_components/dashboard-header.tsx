...
import { useNotifications } from '@/react-query-hooks/hooks/useNotification.query';

interface DashboardHeaderProps {
  unreadCount: number;
}

export const DashboardHeader: React.FC<DashboardHeaderProps> = ({ unreadCount }) => {
...
//   const markAsReadMutation = useMarkNotificationAsRead();
  ...
  const handleNotificationClick = (notification: IEShippingNotification) => {
    if (!notification.poNumber) return;
